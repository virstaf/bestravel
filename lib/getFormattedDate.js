 ...
 * Performance: Hoisting Intl.DateTimeFormat instances is up to ~60x faster
 * than calling .toLocaleDateString() repeatedly.
 */
...
/**
 * Formats a date string into a long date (e.g., January 1, 2024).
...
/**
 * Formats a date string into a short date with time (e.g., Jan 1, 2024, 12:00 PM).
 * Includes validation to return 'N/A' for invalid inputs.
 */
