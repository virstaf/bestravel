...
/**
 * ReservationsSection component.
 * Performance: Accepts profile, reservations, and trips as props to avoid redundant fetching.
 */
const ReservationsSection = ({ profile, reservations, trips }) => {
