...
/**
 * QuoteCard component optimized for performance.
 * Uses hoisted Intl formatters to avoid redundant object creation.
 * Wrapped in React.memo to prevent unnecessary re-renders in list views.
 */
