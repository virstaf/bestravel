...
/**
 * Optimized SlidingCard component for testimonials.
 * Wrapped in React.memo to prevent unnecessary re-renders when the parent slider updates.
 */
const SlidingCard = memo(function SlidingCard({ message, author, stars }) {
  const totalStars = 5;
