...
import { Check, Users, CreditCard, Clock, Shield } from "lucide-react";

/**
 * Hoisted static trust items to avoid recreation on every render.
 */
const TRUST_ITEMS = [
  {
    icon: Users,
 ...
 * Skips re-renders unless parent props change (which they don't here).
 */
